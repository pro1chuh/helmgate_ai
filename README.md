...
|---|---|---|
| Текст, общение | Llama 3.3 70B | AI-router |
| Код, разработка | KAT-Coder-Pro V2 | AI-router |
| Глубокий анализ, стратегия | Gemini 2.5 Pro | AI-router |
| Анализ изображений | Grok 4.20 Vision | AI-router |
| Генерация изображений | Gemini 2.5 Flash Image | AI-router |
| Голос → текст (ASR) | Whisper Large v3 Turbo | Groq |
| Ответы по документам (RAG) | Llama 3.3 70B + ChromaDB | AI-router |
| AI-классификатор запросов | Gemma 3 4B | AI-router |
