...
- Чаты - история, стриминг ответов через SSE, пагинация
- RAG-пайплайн - загрузка PDF/DOCX/TXT, автоиндексация в ChromaDB, семантический поиск (локальные ONNX-эмбеддинги, без API)
